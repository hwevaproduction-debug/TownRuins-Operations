...
describe("link strategies", () => {
  ...
  describe("shortest", () => {
    ...
    // Collision same-folder preference is NOT implemented on the CrawlLinks
    // runtime path (bundled utils). Durable gate: content absolute hubs +
    // npm run check:hub-slugs (see scripts/check-hub-data-slugs.mjs).
  })
